...
3. run `npm install`
4. run `npm start`. The server should be running locally on port 3001 - This is a local server
...
6. ~The server is also deployed here https://fe2-fetch-practice.herokuapp.com/v1/users.~
